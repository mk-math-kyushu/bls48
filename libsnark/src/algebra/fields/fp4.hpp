...
public:
    ...
    static my_Fp2 non_residue;//static my_Fp2 non_residue;
    static my_Fp2 Frobenius_coeffs_c1[4]; // non_residue^((modulus^i-1)/2) for i=0,1,2,3
...
template<mp_size_t n, const bigint<n>& modulus>
Fp2_model<n, modulus> Fp4_model<n, modulus>::non_residue;
//Fp_model<n, modulus> Fp4_model<n, modulus>::non_residue;

template<mp_size_t n, const bigint<n>& modulus>
Fp2_model<n, modulus> Fp4_model<n, modulus>::Frobenius_coeffs_c1[4];
